...
const Privacy = () => <div>
 <article>
  ...
  <p>Last updated: April 03, 2017</p>
<p><strong>This app is still under active development. It is not meant to be used by any body other than its developers. By using it, you relinquish any claim to any privacy violation that may ensue</strong></p>   
<p>This privacy policy sets out how “MVP” uses and protects any information that you give “MVP” when you use this website.</p>
<p>“MVP” is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website,</p>
<p>then you can be assured that it will only be used in accordance with this privacy statement.</p>
<p>“MVP” may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from April 3 2017.</p>
...
<p>We will not sell, distribute or lease your personal information to third parties unless we have your permission or are required by law. We may use your personal information to send you promotional information about third parties which we think you may find interesting if you tell us that you wish this to happen.<br />
    <br />
  You may request details of personal information which we hold about you under the Data Protection Act 1998. A small fee will be payable. If you would like a copy of the information held on you please write to [address].<br />
  <br />
